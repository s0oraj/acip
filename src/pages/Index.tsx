      ...
      <div className="relative">
        ...
        <div className="max-w-7xl mx-auto px-4 py-12 relative">
          <div className="text-center mb-20">
            ...
            <h1 className="text-6xl font-bold mb-6 max-w-4xl mx-auto bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-600 dark:from-blue-400 dark:via-indigo-400 dark:to-blue-400">
