...
import { ArrowUpDown, Play, Pause, RotateCcw, ChevronLeft, ChevronRight } from 'lucide-react';
import { patterns } from './data';

const Visualizer: React.FC = () => {
  const [activePattern, setActivePattern] = useState('closestSubsequenceSum');
  ...
  const renderVisualization = () => {
    const currentData = patterns[activePattern].data;
    const currentTarget = 'target' in patterns[activePattern] ? patterns[activePattern].target : null;
    return (
